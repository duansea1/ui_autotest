...
class WaveGeneration:
    ...
    no_data_pic=By.XPATH,'//div[@id="selectForm:j_id549"]/img',"没有符合条件的记录-图片"
    ...
    '''TMS承运商指派元素'''
    user = By.XPATH, '//*[@id="login-from"]/div[2]/input','用户名'  # 域账号用户名
    pwd = By.XPATH, '//*[@id="login-from"]/div[3]/input','密码'  # 域账号用户名
    login_button = (By.CSS_SELECTOR, "#login-from > span")
    frame=By.XPATH,'//iframe','主界面frame'
    do_input=By.ID,'layui_input_xx','do输入框'
    query_btn=By.ID,'address_query_btn','查询按钮'
    check_box=By.XPATH,'/html/body/div/div[2]/div[2]/div[1]/div[3]/div[1]/table/thead/tr/th[2]/div/div/i','勾选框'
    assign_btn=By.XPATH,'//button[text()="指派"]','指派按钮'
    popup_frame=By.XPATH,'//*[@id="layui-layer-iframe1"]','弹窗frame'
    carrier_choose=By.XPATH,'//*[@id="layui_form_xx"]/div/div[1]/div/div/div/input','承运商选框'
    assign = (By.XPATH,'//*[@id="layui_form_xx"]/div/div[2]/div/button')  #弹窗-指派
    gz_debang = (By.XPATH, '//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="广州药城德邦"]')
    cq_debang = (By.XPATH, '//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="重庆药城德邦"]')
    cq_yuantong = (By.XPATH,'//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="重庆药城圆通"]')
    ks_debang = (By.XPATH,'//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="昆山药城德邦"]')
    yw_jingdong = (By.XPATH,'//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="京东物流药网"]')
    yw_yuantong = (By.XPATH,'//*[@id="layui_form_xx"]/div/div[1]/div/div/dl/dd[text()="圆通药网"]')
...
class Encasement:
    ...
    product_nocheck_count=By.ID,'productPendingEl',"未装箱商品总数"
