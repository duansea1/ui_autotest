...
class SupplierCheck(BasePage.Base):
    """homepage 对象"""
    ...
    def get_search_result(self):
        ...
        :return:
        """
        self.click(R.supplier_check.reset_button)
        sleep(1)
        self.click(R.supplier_check.search)
        sleep(6)
    ...
    def get_search_by_supplierName(self,supplier_name):
        ...
        """
        self.click ( R.supplier_check.reset_button )
        self.send_keys(R.supplier_check.supplier_name,supplier_name)
        self.click(R.supplier_check.search)
        sleep(3)
    ...
    def get_search_by_supplierCode(self,supplier_code):
        ...
        """
        self.click ( R.supplier_check.reset_button )
        self.send_keys(R.supplier_check.supplier_code,supplier_code)
        self.click(R.supplier_check.search)
        sleep(3)
    ...
    def get_search_by_supplierStatus(self,j):
        ...
        #self.click(R.supplier_check.supplier_status)
