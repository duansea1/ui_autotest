...
class BrandManage(BasePage.Base):
    """homepage 对象"""
    ...
    def search_all(self):
        ...
        :return:
        """
        self.click(R.brand_manage.search)
        sleep(3)

    def search_by_brandName(self,brandName):
        """根据合同编号查询"""
        self.send_keys(R.brand_manage.brand_name,brandName)
        self.click(R.brand_manage.search)
        sleep(3)
