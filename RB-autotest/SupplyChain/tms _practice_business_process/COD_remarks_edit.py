...
first_remark = browser.find_element_by_xpath('/html/body/div[1]/div/div/div[8]/div[1]/div[2]/table/tbody/tr/td[24]/div/a')
print(do)
print(first_remark.text)
first_remark.click()
sleep(2)
print('切换到备注弹窗frame')
browser.switch_to_frame(browser.find_element_by_id('layui-layer-iframe1'))
sleep(1)
print('输入备注信息')
time=time.strftime('%Y-%m-%d %H:%M:%S',time.localtime(time.time()))
remark_text="自动化测试编辑备注 "+time
# browser.find_element_by_name('remark').send_keys(Keys.ENTER)
