...
class myaowang(object):
    ...
    def visit_index(self):
        ...
        #选择密码登陆
        self.driver.find_element_by_xpath("//a[text()=\"账号密码登录\"]").click()
        #输入账号
        self.driver.find_element_by_xpath("//input[@type='text' and @placeholder='请输入用户名/手机号']").send_keys('18845592395')
        #输入密码
        self.driver.find_element_by_xpath("//input[@type='password' and @placeholder='请输入密码']").send_keys('GUO199610')
        #登陆判断是否有滑块验证
