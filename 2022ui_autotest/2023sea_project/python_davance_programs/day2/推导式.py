...
cooks = "ey=JzdWIiOiIx.Ii=wiaXNzIj.oiaHR0cDpcL1wvOiIsImV4cCI=6MTY5O.DM1NzQ2NCwiaWF0IjoxNjk=4MzE0MjY0L.CJuYm=iOjE2O"
new_cookie = {}
...
[{cook.split("=")[0]:cook.split("=")[1] for cook in cooks.split('.')}]