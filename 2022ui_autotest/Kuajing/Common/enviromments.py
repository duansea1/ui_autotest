...
def get_envs(env):
    if env == 'fat-sea-agent-hzl':  # 海之蓝代理商
        base_env = {
            "pfxpath": get_files("FatAgentFiles", "key_5182240909000002158@@2409101910000000504.pfx"),
            "cerpath": get_files("FatAgentFiles", "key_5182240909000002158@@2409101910000000504.cer"),
        ...
        base_env = {
            "pfxpath": get_files("FatTenantFiles", "key_5181240821000008798@@2408281533000001302.pfx"),
            "cerpath": get_files("FatTenantFiles", "key_5181240821000008798@@2408281533000001302.cer"),
        ...
        base_env = {
            "pfxpath": get_files("FatTenantFiles", "key_5181240628000024148@@2412041416000002198.pfx"),
            "cerpath": get_files("FatTenantFiles", "key_5181240628000024148@@2412041416000002198.cer"),
        ...
        base_env = {
            "pfxpath": get_files("UatTenantFiles", "key_5181240829000137108@@2408291525000006449.pfx"),
            "cerpath": get_files("UatTenantFiles", "key_5181240829000137108@@2408291525000006449.cer"),
