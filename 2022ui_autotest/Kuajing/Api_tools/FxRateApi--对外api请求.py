...
if __name__ == '__main__':
    ...
    # confirm_exchange(env="uat-sea-tx", userReqNo=userReqNo, apiType=2)    # TODO-2 GEP汇兑锁定确认-商户
    # confirm_exchange_agent(env=fat11_env, userReqNo=userReqNo)  # TODO-跨境b2b 汇兑单确认--代理商
