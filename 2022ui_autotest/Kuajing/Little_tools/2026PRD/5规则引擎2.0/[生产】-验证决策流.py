...
# ==================== 公共配置 ====================
url = "http://payful-rul-core/v1/decision/flow/query/api/execute"
...
if __name__ == "__main__":
    ...
    # 决策流编码
    decisionFlowCode = "JUMIA_NEW_2"

    # 业务数据（按实际需要填入）
    biz_data = {
        "JUMIA_FIRST_PAYEE_30_DAYS": "-1"
    }
    ...
    data = {
        ...
        "initiatingParty": "sea-生产验证-测试决策流",
        "operator": f"生产验证-{decisionFlowCode}",
        "bizData": biz_data,
        "extensionData": {}
    }
